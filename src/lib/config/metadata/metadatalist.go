...
var (
	...
	ConfigList = []Item{
		...
		{Name: common.RecEngineAdapterURL, Scope: SystemScope, Group: BasicGroup, EnvKey: "REC_ENGINE_ADAPTER_URL", DefaultValue: "http://rec-engine-adapter:8080", ItemType: &StringType{}, Editable: false},
		...
		{Name: common.WithRecEngine, Scope: SystemScope, Group: BasicGroup, EnvKey: "WITH_REC_ENGINE", DefaultValue: "false", ItemType: &BoolType{}, Editable: true},
